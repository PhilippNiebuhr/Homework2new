...
ggplot(tidyweather, aes(x=date, y = delta))+
  ...
  theme_bw() +
  labs (
    title = "Weather Anomalies", x="Date", y="Temperature deviation", 
...
ggplot(tidyweather, aes(x=date, y = delta))+
  ...
  theme_bw() +
  labs (
    title = "Weather Anomalies", y="Temperature deviation", 
    caption = "Source: https://data.giss.nasa.gov/gistemp/tabledata_v3/NH.Ts+dSST.txt"
  )
...
Confidence interval for week 15 gives a higher estimation of population mean than week 34, while it has a wider range than week 34. This is perhaps because Trump gave a higher net approval rate during week 15 than 34, and standard deviation in week 34 is also higher.
...
Biked hired in May and June in 2020 compared with previous years dropped significantly, prababily attributed to lockdown
